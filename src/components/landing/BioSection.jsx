...
<h2 style={{fontSize:"clamp(28px,4vw,40px)",fontWeight:800,color:" #1E293B",marginBottom:"8px"}}>Meet Sam</h2>
<p style={{color:" #1E293B",fontSize:"17px",fontWeight:600,marginBottom:"16px",lineHeight:1.7}}>I build working AI systems for professionals. Here's my background and why I do this.</p>
<p style={{color:" #475569",fontSize:"16px",lineHeight:1.7,marginBottom:"12px"}}>Before this, I spent 4+ years as an AI-native marketer, building affiliate and influencer programs across fintech, media, and gaming. I don't just use AI tools - I build with them: automations in ChatGPT, Gemini, Claude, and N8N, and full working apps and CRMs in Base44.</p>
<p style={{color:" #475569",fontSize:"16px",lineHeight:1.7,marginBottom:"12px"}}>I've worked with professionals and business owners in Israel, the UK, and the US. Every single person left the call with something they could use immediately.</p>
