    ...
    <section style={{ background: "#0F172A", padding: "56px 24px" }}>
      <div style={{ maxWidth: 820, margin: "0 auto" }}>
        <div style={{ background: "#0B1526", border: "1px solid #1E293B", borderRadius: 18, padding: "40px" }}>
          <div style={{ color: "#F97316", fontWeight: 700, fontSize: "13px", letterSpacing: "1.5px", textTransform: "uppercase", marginBottom: "14px" }}>For Teams</div>
          ...
          <Link to="/teams" style={{ display: "inline-block", background: "#F97316", color: "#FFFFFF", fontWeight: 700, fontSize: "16px", padding: "14px 28px", borderRadius: "50px", textDecoration: "none" }}>Explore the Team Pilot</Link>
