...
{icon:<svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke=" #F97316" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>,title:"Nothing You Try Actually Sticks",body:"You've tried ChatGPT, Copilot, Gemini, Perplexity, Claude. You played around. You got nowhere. Nothing produced anything useful for your real day-to-day work."},
...
<h3 style={{fontWeight:700,color:" #1E293B",fontSize:"20px",marginBottom:"12px"}}>{c.title}</h3>
<p style={{color:" #64748B",fontSize:"15px",lineHeight:1.7}}>{c.body}</p>
</div>)}
</div>
<div style={{textAlign:"center"}}>
<p style={{fontSize:"clamp(22px,3vw,28px)",fontWeight:800,color:" #1E293B",maxWidth:"700px",margin:"0 auto 32px",lineHeight:1.4}}>The problem isn't you.<br/>No one has ever built an AI solution for YOUR specific job. Until now.</p>
...
<p style={{color:" #64748B",fontSize:"13px",marginTop:"10px"}}>I'll tell you the one AI tool you should be using right now. Free, in 20 minutes, no pitch.</p>
<div style={{marginTop:"12px",maxWidth:"600px",margin:"12px auto 0"}}>
<p style={{color:" #94A3B8",fontSize:"13px",marginBottom:"4px",fontStyle:"italic"}}>"What if I'm not technical at all?" — Perfect. That's exactly who this is for. I explain everything in plain language and do all the technical work live. No tech knowledge required.</p>
<p style={{color:" #94A3B8",fontSize:"13px",margin:0,fontStyle:"italic"}}>"Is the 20-minute call a sales pitch?" — No. It's a genuine working call. I tell you exactly what I'd build for you. If it doesn't feel right, we end the call. No pressure.</p>
</div>
</div>
</div>
<style>{`@media(max-width:768px){.pg{grid-template-columns:1fr!important}}`}</style>
</section>
);
}
