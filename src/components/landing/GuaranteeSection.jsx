...
<p style={{color:" #94A3B8",fontSize:"15px",lineHeight:1.7,maxWidth:"560px",margin:"0 auto 32px"}}>Your session also includes 14 days of direct WhatsApp access to Sam. Got a prompt that's not working, or a new task to automate? Message him directly. Not a ticket system. Direct access. He responds within 24 hours.</p>
