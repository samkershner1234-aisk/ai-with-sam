...
const faqs=[
  ...
  {q:"What happens after the session?",a:"You receive a full recording of the session, a written recap document with all your custom prompts and next steps, and 14 days of direct WhatsApp access to Sam. Got a prompt that's not working, or a new task to automate? Message him directly. Not a ticket system. Direct access."},
